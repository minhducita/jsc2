...
class UploadFile extends Model
{
    ...
    {
        return [
            [['file'], 'file', 'skipOnEmpty' => false, 'extensions' => 'png, jpg, gif, jpeg, doc, docx, pdf, txt, ppt, pptx, pps, ppsx, xls, xlsx, zip, rar', 'maxSize' => 1024 * 1024 * 100, 'checkExtensionByMimeType'=>false],
        ];
    }
